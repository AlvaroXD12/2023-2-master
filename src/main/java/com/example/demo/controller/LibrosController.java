...
public class LibrosController {
	...
	@PutMapping("/editar/{id}")
	  public ResponseEntity<LibrosEntity> updateTutorial(@PathVariable("id") long id, @Valid @RequestBody LibrosEntity libr) {
	    ...
	    if (libros!=null) {
	    	...
	    	libros.setAutores(libr.getAutores());
	    	libros.setCategorias(libr.getCategorias());
	    	libros.setEditoriales(libr.getEditoriales());
